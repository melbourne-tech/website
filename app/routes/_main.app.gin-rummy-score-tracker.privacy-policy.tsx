...
export default function GinRummyScoreTrackerPrivacyPolicyPage() {
  return (
    <article className="w-full max-w-xl px-4 mx-auto my-8 sm:my-12 md:my-16 prose">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named Gin
            Rummy Score Tracker
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Gin Rummy Score Tracker.
          </p>
        </li>
        <li>
          <p>
      ...
      <h3>No Personal Data is collected</h3>
      <p>
        While using Our Service, we do not track any personal or usage data. All
